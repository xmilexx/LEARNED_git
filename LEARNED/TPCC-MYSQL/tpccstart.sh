...
./mysql-5.7.24/tpcc-mysql/tpcc_start -h127.0.0.1 -S/tmp/mysql.sock -dtpcc1000 -uroot -p2702 -w1000 -c32 -r10 -l10800 &>$RESULT_DIR/tpcc.txt & echo $password | sudo -S iostat -x 10 1080 &>$RESULT_DIR/iostat.txt
